...
{
    public static class EmotionFunction
    {
        [FunctionName("EmotionFunction")]
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            try
            {
                log.Info("EmotionFunction - Started");
                ...
                log.Info($"EmotionFunction - Url: {url}");
                log.Info($"EmotionFunction - ApiKey: {apiKey}");
                log.Info($"EmotionFunction - Endpoint: {domainEndpoint}");
